...
if __name__=="__main__":
    ...
    adptative_values = tradeoff([0.6577,0.5209,0.5034,0.4981],[1.3,2.58,3.44,4.33])

    optimized_labels = ["Level 66","Level 123","Level 124","Level 156"]
    optimized_values = tradeoff([0.6582,0.6429,0.5949,0.5525],[1.2417833123908109,1.3008506129573985,1.469192531290397,2.399349331176418])
    ...
    plt.title("DT - Observador Interno",fontsize=24)
