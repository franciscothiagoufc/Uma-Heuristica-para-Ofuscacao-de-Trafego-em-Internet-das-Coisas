...
if __name__=="__main__":
    ...
    adptative_values = tradeoff([0.3206,0.1371,.0933,0.0743],[1.3,2.58,3.44,4.33])

    optimized_labels = ["Level 66","Level 123","Level 124","Level 156"]
    optimized_values = tradeoff([0.3551,0.2392,0.1868,0.2629],[1.2417833123908109,1.3008506129573985,1.469192531290397,2.399349331176418])
    ...
    plt.title("KNN - Observador Externo",fontsize=24)
