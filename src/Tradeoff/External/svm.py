...
if __name__=="__main__":
    ...
    adptative_values = tradeoff([0.1938,0.1988,0.1989,0.1987],[1.3,2.58,3.44,4.33])

    optimized_labels = ["Level 66","Level 123","Level 124","Level 156"]
    optimized_values = tradeoff([0.4465,0.4655,0.4318,0.2892],[1.2417833123908109,1.3008506129573985,1.469192531290397,2.399349331176418])
