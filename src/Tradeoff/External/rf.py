...
if __name__=="__main__":
    ...
    adptative_values = tradeoff([.3277,.1428,.0594,.0496],[1.3,2.58,3.44,4.33])

    optimized_labels = ["Level 66","Level 123","Level 124","Level 156"]
    optimized_values = tradeoff([0.3330,0.2265,0.1415,0.2817],[1.2417833123908109,1.3008506129573985,1.469192531290397,2.399349331176418])
    ...
    plt.title("RF - Observador Externo",fontsize=24)
